...
namespace BlazorFullStackCrud.Server.Controllers
{
    ...
    [ApiController]
    public class UnitBisnisController : ControllerBase
    {
        private readonly DataContext _context;

        public UnitBisnisController(DataContext context)
        {
            _context = context;
        }

        [HttpGet]
        public async Task<ActionResult<List<UnitBisnis>>> GetUnitBisnis()
        {
            var unitBisnis = await _context.UnitBisnis.ToListAsync();
            return Ok(unitBisnis);
        }
